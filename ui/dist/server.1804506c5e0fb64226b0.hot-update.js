  ...
  const generateText = () => {
    if (notification.action === "like") {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "font-bold"
      }, "`$", !giver.firstame ? giver.username : giver.firstname, "`+") + ` vind je foto <span className="font-bold">${photo.title}</span> leuk`;
    }
...
//# sourceMappingURL=server.1804506c5e0fb64226b0.hot-update.js.map