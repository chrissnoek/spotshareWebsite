...
const Notifications = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "absolute bg-white rounded p-6 border z-10 right-0",
    id: "notifications"
...
const Notification = ({
  ...
  const generateText = () => {
    if (notification.action === "like") {
      return `<span className="font-bold">${!giver.firstame ? giver.username : giver.firstname}</span> vind je foto <span className="font-bold">${photo.title}</span> leuk`;
    }

    if (notification.action === "comment") {
      return `<span className="font-bold">${!giver.firstame ? giver.username : giver.firstname}</span> heeft gereageerd op je foto <span className="font-bold">${photo.title}</span>`;
    }

    if (notification.action === "follow") {
      return `<span className="font-bold">${!giver.firstame ? giver.username : giver.firstname}</span> volgt je nu!`;
    }
  };
...
//# sourceMappingURL=server.cd426f247eab6a1c9384.hot-update.js.map